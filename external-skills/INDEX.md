...
- **Repository:** https://github.com/BehiSecc/awesome-claude-skills.git
- **Files:** 0
- **Path:** `external-skills/awesome-claude-skills-2/`

### claude-code-infrastructure

- **Repository:** https://github.com/diet103/claude-code-infrastructure-showcase.git
- **Files:** 47
- **Path:** `external-skills/claude-code-infrastructure/`
